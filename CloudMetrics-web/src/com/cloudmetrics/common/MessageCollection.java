...
public class MessageCollection {
   ...
   public static final String INTERNAL_ERROR_WHILE_ADDING_Company = "Sorry. Your account could not be created due to an internal error.";
   ...
   public static final String Company_DOES_NOT_EXIST_NEEDED_BEFORE_CREATING_PROFILE = "The Company does not exist. An account needs to be created first, before creating a profile.";
   public static final String Company_DOES_NOT_EXIST_NEEDED_BEFORE_CHOOSING_PASSWORD = "The Company does not exist. An account needs to be created first, before choosing a password.";
